...
router.get("/overview", checkAuth(), requireCompany, ProjectMemberController.getAssignmentOverview);
router.get("/:projectId", checkAuth(), requireCompany, ProjectMemberController.getProjectMembers);
