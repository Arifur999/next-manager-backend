...
router.patch("/exchange-rates/default", checkAuth(Role.admin), validateRequest(setDefaultRateZodSchema), SettingsController.setDefaultRate);
...
router.post("/exchange-rates/refresh", checkAuth(Role.admin), authRateLimit, SettingsController.refreshRate);
